...
def test_is_isogram_false_repeated_letters():
...
def test_is_isogram_known_long_isogram():
    assert is_isogram('Subdermatoglyphic') is True


def test_is_isogram_all_same_letters():
    assert is_isogram('AAAA') is False


def test_is_isogram_mixed_case_duplicates():
    assert is_isogram('Alphabet') is False


def test_is_isogram_long_non_isogram():
