...
class TestIsIsogram:
    ...
    def test_alternating_case_same_letters(self) -> None:
    ...
    def test_parametrized_cases(self, word: str, expected: bool) -> None:
