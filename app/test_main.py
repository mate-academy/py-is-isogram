...
class TestIsIsogram:
    ...
    def test_single_character_is_isogram(self, word):
    ...
    def test_valid_isograms(self, word):
    ...
    def test_invalid_isograms_with_repeating_letters(self, word):
...
def test_comprehensive_isogram_cases(test_input, expected):
