...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("look", False, id="should return False when same letter is lowercase"),
        pytest.param("Adam", False, id="should return False when same letter in different cases"),
